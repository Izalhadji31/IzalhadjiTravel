...
#[Fillable(['user_id', 'route_id', 'number_of_seats', 'total_price', 'booking_code', 'status', 'scheduled_date', 'departure_time', 'assigned_armada_id', 'selected_seats', 'passenger_data'])]
class TravelBooking extends Model
{
    ...
    {
        return $this->hasMany(TravelSeat::class, 'travel_booking_id');
    }
