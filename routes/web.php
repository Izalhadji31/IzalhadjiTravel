...
Route::middleware(['auth'])->group(function () {
    ...
    // Seat Availability Routes (Web/Session Auth)
    Route::prefix('seat-availability')->group(function () {
        Route::get('/availability', [SeatAvailabilityController::class, 'getAvailability'])->name('seat-availability');
        Route::post('/lock', [SeatAvailabilityController::class, 'lockSeats'])->name('seat-availability.lock');
        Route::post('/unlock', [SeatAvailabilityController::class, 'unlockSeats'])->name('seat-availability.unlock');
        Route::post('/check', [SeatAvailabilityController::class, 'checkAvailability'])->name('seat-availability.check');
    });
