...
Route::middleware('api')->group(function () {
     ...
     */
    Route::middleware('auth:sanctum')->prefix('seats')->group(function () {
        Route::get('/availability', [SeatAvailabilityController::class, 'getAvailability']);
        Route::post('/lock', [SeatAvailabilityController::class, 'lockSeats']);
        Route::post('/unlock', [SeatAvailabilityController::class, 'unlockSeats']);
        Route::post('/check', [SeatAvailabilityController::class, 'checkAvailability']);
        Route::get('/locked', [SeatAvailabilityController::class, 'getUserLockedSeats']);
        Route::get('/date-range', [SeatAvailabilityController::class, 'getDateRangeAvailability']);
        Route::post('/cleanup', [SeatAvailabilityController::class, 'cleanupExpiredLocks']);
    });
});
