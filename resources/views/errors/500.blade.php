...
<head>
    ...
    <title>{{ __('errors.500_title') }} - Server Error | ASR GO</title>
...
<body class="min-h-screen bg-gradient-to-br from-red-50 via-white to-orange-50 flex items-center justify-center p-4">
    <div class="text-center max-w-lg">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mb-3">{{ __('errors.500_heading') }}</h1>
        <p class="text-gray-500 mb-8">{{ __('errors.500_message') }}</p>
