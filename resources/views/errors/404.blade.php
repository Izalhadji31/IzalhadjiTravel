...
<head>
    ...
    <title>{{ __('errors.404_title') }} - {{ __('errors.404_heading') }} | ASR GO</title>
...
<body class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center p-4">
    <div class="text-center max-w-lg">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mb-3">{{ __('errors.404_heading') }}</h1>
        <p class="text-gray-500 mb-8">{{ __('errors.404_message') }}</p>
