...
<div class="bg-white border-b border-gray-100 sticky top-0 z-40 shadow-sm">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <button onclick="filterKota('ende')" class="kota-btn px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-all" data-kota="ende">{{ __('destinasi.ende') }}</button>
            <button onclick="filterKota('larantuka')" class="kota-btn px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-all" data-kota="larantuka">{{ __('destinasi.larantuka') }}</button>
            <button onclick="filterKota('maumere')" class="kota-btn px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-all" data-kota="maumere">{{ __('destinasi.maumere') }}</button>
            <button onclick="filterKota('mbay')" class="kota-btn px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-all" data-kota="mbay">{{ __('destinasi.mbay') }}</button>
            <button onclick="filterKota('bajawa')" class="kota-btn px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-all" data-kota="bajawa">{{ __('destinasi.bajawa') }}</button>
            <button onclick="filterKota('borong')" class="kota-btn px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-all" data-kota="borong">{{ __('destinasi.borong') }}</button>
            <button onclick="filterKota('ruteng')" class="kota-btn px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-all" data-kota="ruteng">{{ __('destinasi.ruteng') }}</button>
            <button onclick="filterKota('labuan-bajo')" class="kota-btn px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-all" data-kota="labuan-bajo">{{ __('destinasi.labuan_bajo') }}</button>
        </div>
    </div>
</div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="kota-section mb-16" data-kota="ende">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">{{ __('destinasi.ende') }}</h2>
                    <p class="text-gray-500">{{ __('destinasi.section_ende_desc') }}</p>
                </div>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                <a href="{{ route('public.destinasi.detail', 'danau-kelimutu') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_danau_kelimutu_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_danau_kelimutu_desc') }}</p></div>
                </a>
                <a href="{{ route('public.destinasi.detail', 'rumah-bung-karno') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_rumah_bung_karno_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_rumah_bung_karno_desc') }}</p></div>
                </a>
                <a href="{{ route('public.destinasi.detail', 'pantai-ena-bara') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_pantai_ena_bara_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_pantai_ena_bara_desc') }}</p></div>
                </a>
            </div>
        </div>
        ...
        <div class="kota-section mb-16" data-kota="larantuka">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">{{ __('destinasi.larantuka') }}</h2>
                    <p class="text-gray-500">{{ __('destinasi.section_larantuka_desc') }}</p>
                </div>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                <a href="{{ route('public.destinasi.detail', 'benteng-lohayong') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_benteng_lohayong_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_benteng_lohayong_desc') }}</p></div>
                </a>
                <a href="{{ route('public.destinasi.detail', 'bukit-fatima') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_bukit_fatima_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_bukit_fatima_desc') }}</p></div>
                </a>
                <a href="{{ route('public.destinasi.detail', 'pantai-watotena') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_pantai_watotena_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_pantai_watotena_desc') }}</p></div>
                </a>
            </div>
        </div>
        ...
        <div class="kota-section mb-16" data-kota="maumere">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">{{ __('destinasi.maumere') }}</h2>
                    <p class="text-gray-500">{{ __('destinasi.section_maumere_desc') }}</p>
                </div>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                <a href="{{ route('public.destinasi.detail', 'teluk-maumere') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_teluk_maumere_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_teluk_maumere_desc') }}</p></div>
                </a>
                <a href="{{ route('public.destinasi.detail', 'pantai-koka') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_pantai_koka_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_pantai_koka_desc') }}</p></div>
                </a>
                <a href="{{ route('public.destinasi.detail', 'museum-maumere') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_museum_bikon_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_museum_bikon_desc') }}</p></div>
                </a>
            </div>
        </div>
        ...
        <div class="kota-section mb-16" data-kota="mbay">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">{{ __('destinasi.mbay') }}</h2>
                    <p class="text-gray-500">{{ __('destinasi.section_mbay_desc') }}</p>
                </div>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                <a href="{{ route('public.destinasi.detail', 'bunker-jepang-rane') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_bunker_jepang_rane_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_bunker_jepang_rane_desc') }}</p></div>
                </a>
                <a href="{{ route('public.destinasi.detail', 'gunung-ebulobo') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_gunung_ebulobo_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_gunung_ebulobo_desc') }}</p></div>
                </a>
                <a href="{{ route('public.destinasi.detail', 'kampung-adat-kawa') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_kampung_adat_kawa_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_kampung_adat_kawa_desc') }}</p></div>
                </a>
            </div>
        </div>
        ...
        <div class="kota-section mb-16" data-kota="bajawa">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">{{ __('destinasi.bajawa') }}</h2>
                    <p class="text-gray-500">{{ __('destinasi.section_bajawa_desc') }}</p>
                </div>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                <a href="{{ route('public.destinasi.detail', 'kampung-bena') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_kampung_bena_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_kampung_bena_desc') }}</p></div>
                </a>
                <a href="{{ route('public.destinasi.detail', 'gunung-inerie') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_gunung_inerie_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_gunung_inerie_desc') }}</p></div>
                </a>
                <a href="{{ route('public.destinasi.detail', 'taman-laut-17-pulau') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_taman_laut_17_pulau_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_taman_laut_17_pulau_desc') }}</p></div>
                </a>
            </div>
        </div>
        ...
        <div class="kota-section mb-16" data-kota="borong">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">{{ __('destinasi.borong') }}</h2>
                    <p class="text-gray-500">{{ __('destinasi.section_borong_desc') }}</p>
                </div>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                <a href="{{ route('public.destinasi.detail', 'air-terjun-cunca-rede') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_air_terjun_cunca_rede_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_air_terjun_cunca_rede_desc') }}</p></div>
                </a>
                <a href="{{ route('public.destinasi.detail', 'danau-rana-mese') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_danau_rana_mese_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_danau_rana_mese_desc') }}</p></div>
                </a>
                <a href="{{ route('public.destinasi.detail', 'savana-mausui') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_savana_mausui_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_savana_mausui_desc') }}</p></div>
                </a>
            </div>
        </div>
        ...
        <div class="kota-section mb-16" data-kota="ruteng">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">{{ __('destinasi.ruteng') }}</h2>
                    <p class="text-gray-500">{{ __('destinasi.section_ruteng_desc') }}</p>
                </div>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                <a href="{{ route('public.destinasi.detail', 'wae-rebo') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group md:col-span-2 lg:col-span-1">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_wae_rebo_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_wae_rebo_desc') }}</p></div>
                </a>
                <a href="{{ route('public.destinasi.detail', 'gua-liang-bua') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_gua_liang_bua_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_gua_liang_bua_desc') }}</p></div>
                </a>
                <a href="{{ route('public.destinasi.detail', 'sawah-lodok-spiderman') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_sawah_lodok_spiderman_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_sawah_lodok_spiderman_desc') }}</p></div>
                </a>
            </div>
        </div>
        ...
        <div class="kota-section mb-16" data-kota="labuan-bajo">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">{{ __('destinasi.labuan_bajo') }}</h2>
                    <p class="text-gray-500">{{ __('destinasi.section_labuan_bajo_desc') }}</p>
                </div>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                <a href="{{ route('public.destinasi.detail', 'pulau-komodo') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_pulau_komodo_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_pulau_komodo_desc') }}</p></div>
                </a>
                <a href="{{ route('public.destinasi.detail', 'pulau-padar') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_pulau_padar_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_pulau_padar_desc') }}</p></div>
                </a>
                <a href="{{ route('public.destinasi.detail', 'pink-beach') }}" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
                    ...
                    <div class="p-4"><h4 class="font-bold text-gray-900">{{ __('destinasi.card_pink_beach_title') }}</h4><p class="text-gray-500 text-sm">{{ __('destinasi.card_pink_beach_desc') }}</p></div>
                </a>
            </div>
        </div>
