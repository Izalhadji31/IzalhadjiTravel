...
@section('title', 'Syarat & Ketentuan - ASR GO')

@section('content')
<div class="bg-white py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-extrabold text-gray-900 mb-2">Syarat & Ketentuan</h1>
        ...
        <div class="prose prose-gray max-w-none space-y-6 text-gray-700">
            <section>
                <h2 class="text-xl font-bold text-gray-900 border-b pb-2">1. Umum</h2>
            ...
            <section>
                <h2 class="text-xl font-bold text-gray-900 border-b pb-2">2. Pemesanan & Konfirmasi</h2>
            ...
            <section>
                <h2 class="text-xl font-bold text-gray-900 border-b pb-2">3. Pembayaran</h2>
                <ul class="list-disc pl-5 space-y-2">
            ...
            <section>
                <h2 class="text-xl font-bold text-gray-900 border-b pb-2">4. Pembatalan & Refund</h2>
            ...
            <section>
                <h2 class="text-xl font-bold text-gray-900 border-b pb-2">5. Kebijakan Perjalanan</h2>
                <ul class="list-disc pl-5 space-y-2">
            ...
            <section>
                <h2 class="text-xl font-bold text-gray-900 border-b pb-2">6. Rental Mobil</h2>
                <ul class="list-disc pl-5 space-y-2">
            ...
            <section>
                <h2 class="text-xl font-bold text-gray-900 border-b pb-2">7. Tanggung Jawab</h2>
            ...
            <section>
                <h2 class="text-xl font-bold text-gray-900 border-b pb-2">8. Hukum yang Berlaku</h2>
            ...
            <section>
                <h2 class="text-xl font-bold text-gray-900 border-b pb-2">9. Kontak</h2>
