...
@section('title', __('contact.title') . ' - ASR GO')
...
<div class="travel-hero-section" style="padding: 2.5rem 0 2rem;">
    <div class="trvl-container">
        <div style="text-align: center; margin-bottom: 1.5rem;">
            ...
            <p style="color: rgba(255,255,255,0.75); font-size: 0.9rem; margin-top: 0.25rem; font-weight: 400;">{{ __('contact.subtitle') }}</p>
        </div>
    </div>
</div>
        ...
        <div style="max-width: 1100px; margin: 0 auto;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.25rem; margin-bottom: 2.5rem;">
                ...
                <div style="background: var(--trvl-card); border-radius: var(--trvl-radius-lg); border: 1px solid var(--trvl-border); box-shadow: var(--trvl-shadow-sm); padding: 1.5rem;">
                    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                        ...
                        <h3 style="font-size: 1rem; font-weight: 700; color: var(--trvl-gray-900);">{{ __('contact.email_title') }}</h3>
                    </div>
                    <p style="font-size: 0.85rem; color: var(--trvl-gray-600); margin-bottom: 1rem; line-height: 1.5;">{{ __('contact.email_desc') }}</p>
                ...
                <div style="background: var(--trvl-card); border-radius: var(--trvl-radius-lg); border: 1px solid var(--trvl-border); box-shadow: var(--trvl-shadow-sm); padding: 1.5rem;">
                    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                        ...
                        <h3 style="font-size: 1rem; font-weight: 700; color: var(--trvl-gray-900);">{{ __('contact.office_title') }}</h3>
                    </div>
                    <p style="font-size: 0.85rem; color: var(--trvl-gray-600); margin-bottom: 1rem; line-height: 1.5;">{{ __('contact.office_desc') }}</p>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                ...
                <div style="background: var(--trvl-card); border-radius: var(--trvl-radius-lg); border: 1px solid var(--trvl-border); box-shadow: var(--trvl-shadow-sm); padding: 1.75rem;">
                    <h2 style="font-size: 1.25rem; font-weight: 800; color: var(--trvl-gray-900); margin-bottom: 1.5rem;">{{ __('contact.form_title') }}</h2>
                    ...
                    <form method="POST" action="{{ route('public.contact.submit') }}" style="display: flex; flex-direction: column; gap: 1.25rem;">
                        ...
                        <div>
                            <label class="trvl-field-label">{{ __('contact.form_name') }}</label>
                        ...
                        <div>
                            <label class="trvl-field-label">{{ __('contact.form_email') }}</label>
                        ...
                        <div>
                            <label class="trvl-field-label">{{ __('contact.form_phone') }}</label>
                        ...
                        <div>
                            <label class="trvl-field-label">{{ __('contact.form_subject') }}</label>
                        ...
                        <div>
                            <label class="trvl-field-label">{{ __('contact.form_message') }}</label>
                ...
                <!-- Map -->
                <div style="background: var(--trvl-card); border-radius: var(--trvl-radius-lg); border: 1px solid var(--trvl-border); box-shadow: var(--trvl-shadow-sm); padding: 1.75rem;">
                    <h2 style="font-size: 1.25rem; font-weight: 800; color: var(--trvl-gray-900); margin-bottom: 1.5rem;">{{ __('contact.map_title') }}</h2>
                    ...
                    <div style="margin-top: 1.25rem; padding: 1rem 1.125rem; background: linear-gradient(135deg, #eff6ff 0%, #f0f9ff 100%); border: 1px solid #dbeafe; border-radius: var(--trvl-radius-md);">
                        <p style="font-size: 0.82rem; color: var(--trvl-gray-700); margin-bottom: 0.5rem;">
                            <strong>{{ __('contact.hours_title') }}:</strong>
                        </p>
                        <p style="font-size: 0.82rem; color: var(--trvl-gray-600);">{{ __('contact.hours') }}</p>
                        <p style="font-size: 0.82rem; color: var(--trvl-gray-600);">{{ __('contact.hours_emergency') }}</p>
                    </div>
                </div>
            </div>
        </div>
