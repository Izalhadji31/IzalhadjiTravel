...
@section('content')
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
        <a href="{{ route('bookings.travel.create') }}" style="text-decoration: none; color: inherit;">
        ...
        <a href="{{ route('bookings.rental.create') }}" style="text-decoration: none; color: inherit;">
                                ...
                                <tr style="border-bottom: 1px solid var(--trvl-border);">
                                    ...
                                    <td style="padding: 0.75rem;">
                                        ...
                                        @if($booking->status !== 'pending' && $booking->status !== 'completed')
                                            <a href="{{ route('bookings.refund.create', $booking->id) }}" style="display: inline-block; margin-top: 0.25rem; color: #dc2626; text-decoration: none; font-weight: 600; font-size: 0.8rem;">Ajukan Refund</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
