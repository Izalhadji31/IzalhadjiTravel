...
<body class="bg-gray-50">
    <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            <!-- Header -->
            <div class="mb-8">
                <a href="{{ route('bookings.travel') }}" class="text-blue-600 hover:text-blue-700 font-semibold">
                    ← Kembali ke Pemesanan
                </a>
                <h1 class="text-4xl font-bold text-gray-900 mt-4">Pembayaran Travel</h1>
            </div>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="mb-6 pb-6 border-b">
                            <h3 class="font-semibold text-gray-900 mb-2">Rute Perjalanan</h3>
                            <div class="flex items-center gap-4">
                                <div>
                                    <p class="text-sm text-gray-600">Dari</p>
                                    <p class="font-semibold text-gray-900">{{ $booking->route->origin }}</p>
                                </div>
                                <div class="text-2xl text-blue-600">→</div>
                                <div>
                                    <p class="text-sm text-gray-600">Tuju</p>
                                    <p class="font-semibold text-gray-900">{{ $booking->route->destination }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-6 pb-6 border-b">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-900">{{ $booking->number_of_seats }} kursi</p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600">Tanggal Perjalanan</p>
                                <p class="font-semibold text-gray-900">{{ $booking->scheduled_date->format('d M Y') }}</p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600">Waktu Keberangkatan</p>
                                <p class="font-semibold text-gray-900">{{ $booking->departure_time }}</p>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 sticky top-6">
                        ...
                        <div class="space-y-4 mb-6 pb-6 border-b">
                            <div class="flex justify-between">
                                <span class="text-gray-600">Harga Tiket × {{ $booking->number_of_seats }}</span>
    ...
    <script>
        ...
        // Auto-trigger payment if snap token exists
        @if($payment->status === 'pending' && isset($snapToken))
            document.addEventListener('DOMContentLoaded', function() {
                // Optional: auto-trigger or wait for user click
            });
        @endif
    </script>
</body>
