...
<head>
    ...
    <style>
        :root {
            ...
            --trvl-card: #ffffff;
            --trvl-border: #e5e7eb;
            --trvl-gray-600: #666666;
            --trvl-gray-100: #f8fafc;
        }
        .dark {
            --trvl-bg: #1a1a2e;
            --trvl-text: #e0e0e0;
            --trvl-card: #16213e;
            --trvl-border: #2a2a4a;
            --trvl-gray-600: #9ca3af;
            --trvl-gray-100: #1e293b;
        }
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            @if($role === 'driver')
            <div class="sidebar-section">
                <div class="sidebar-section-label">{{ __('sidebar.orders') }}</div>
            ...
            <div class="sidebar-section">
                <div class="sidebar-section-label">{{ __('sidebar.earnings') }}</div>
            ...
            @if($role === 'partner')
            <div class="sidebar-section">
                <div class="sidebar-section-label">{{ __('sidebar.partners') }}</div>
            ...
            <div class="sidebar-section">
                ...
                <a href="{{ route('admin.partners') }}" class="sidebar-link @if(request()->routeIs('admin.partners*')) active @endif">
                ...
                <a href="{{ route('bookings.travel') }}" class="sidebar-link">
                    ...
                    {{ __('sidebar.booking_travel') }}
                </a>
                <a href="{{ route('bookings.rental') }}" class="sidebar-link">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012-2"/></svg>
                    {{ __('sidebar.booking_rental') }}
                </a>
                ...
                <a href="{{ route('identity.admin.pending') }}" class="sidebar-link @if(request()->routeIs('identity.*')) active @endif">
                    ...
                    {{ __('sidebar.identity_verification') }}
                </a>
        ...
        <div class="topbar">
            <div class="topbar-left">
                <div class="search-box" id="globalSearchBox">
                    ...
                    <input type="text" id="globalSearchInput" placeholder="{{ __('topbar.search_placeholder') }}" autocomplete="off">
                    <!-- Search Dropdown -->
            ...
            <div class="topbar-right">
                ...
                <a href="{{ route('lang.switch', ['locale' => app()->getLocale() === 'id' ? 'en' : 'id']) }}" 
                   ...
                   title="{{ app()->getLocale() === 'id' ? 'English' : 'Indonesia' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width:18px;height:18px;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"/></svg>
                </a>
                    ...
                    debounceTimer = setTimeout(function () {
                        fetch('{{ route("api.search") }}?q=' + encodeURIComponent(query))
                            ...
                            .then(data => {
                                let html = '';
                                const sections = [
                                    { key: 'routes', label: '{{ __("topbar.search_routes") }}', icon: '🛣️' },
                                                    { key: 'vehicles', label: '{{ __("topbar.search_vehicles") }}', icon: '🚗' },
                                                    { key: 'drivers', label: '{{ __("topbar.search_drivers") }}', icon: '👤' },
                                                    { key: 'partners', label: '{{ __("topbar.search_partners") }}', icon: '🤝' },
                                ];
