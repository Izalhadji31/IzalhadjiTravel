    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="sidebar-section">
                ...
                <a href="{{ route('bookings.rental.search') }}" class="sidebar-link @if(request()->routeIs('bookings.rental*')) active @endif">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/></svg>
                    Rental
                </a>
                <a href="{{ route('bookings.airport-transfer.create') }}" class="sidebar-link @if(request()->routeIs('bookings.airport-transfer*')) active @endif">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/></svg>
                    Airport Transfer
                </a>
            </div>
